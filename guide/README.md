...
For bots to run on the cloud, they **must** use the [DAZL API](https://github.com/digital-asset/dazl-client), rather than e.g. the Java or Scala clients, and they may _not_ do any I/O.
